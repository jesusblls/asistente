...
export function Navbar() {
  ...
  const navLinks = [
    ...
    { name: 'Casos Clínicos', href: '#testimonios' },
    ...
    <header 
      className={`sticky top-0 z-50 transition-all duration-200 ${
        isScrolled 
          ...
          : 'bg-white/70 backdrop-blur-xs border-b border-slate-200/50'
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16 sm:h-[68px]">
          ...
          <Link href="/" className="flex items-center gap-3 group shrink-0">
            <div className="relative">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-teal-600 flex items-center justify-center text-white shadow-xs group-hover:bg-teal-700 transition-colors">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5">
                ...
                <span className="bg-teal-50 text-teal-800 text-[10px] font-bold px-1.5 py-0.5 rounded-full border border-teal-200">
                  Clínicas
                </span>
              </div>
          ...
          <nav className="hidden lg:flex items-center space-x-0.5 xl:space-x-1">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="px-3 py-1.5 text-sm font-medium text-slate-600 hover:text-slate-950 hover:bg-slate-100/80 rounded-lg transition-colors"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-2.5">
            {/* Live Demo Phone Pill */}
            <a
              href="#demo"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-700 hover:text-slate-900 bg-slate-100/90 hover:bg-slate-200/80 rounded-lg transition-colors border border-slate-200/60"
              title="Línea de conmutador de prueba en CDMX"
            >
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold text-slate-700 hover:text-slate-950 hover:bg-slate-100/80 rounded-xl transition-colors"
            >
            ...
            <a
              href="#demo"
              className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold text-white bg-teal-600 hover:bg-teal-700 rounded-xl shadow-xs transition-all active:scale-95"
            >
          ...
          <div className="flex md:hidden items-center gap-2">
            <Link
              href="/dashboard"
              className="p-2 text-sm font-semibold text-teal-700 bg-teal-50 border border-teal-200 rounded-lg"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-b border-slate-200 bg-white/95 backdrop-blur-xl px-4 pt-3 pb-6 shadow-xl animate-in slide-in-from-top-2 duration-150">
