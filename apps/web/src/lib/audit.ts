...
import {
  ...
  type AuditSensitivity as SharedAuditSensitivity,
  type AuditScheduleContext,
  type DoctorScheduleContext,
...
// ---------------------------------------------------------------------------
//
// La clasificación vive en @asistente/shared-types (auditSensitivity.ts) y la
// comparte este panel con el filtro `onlySensitive` del backend
// (apps/api/src/routes/admin/audit.ts), para que ambos lados coincidan
// siempre en qué evento es sensible.

export type Sensitivity = SharedAuditSensitivity;
export type { DoctorScheduleContext, AuditScheduleContext };
